...
#Significa que el periodo es 8 ns=125 MHz, con un duty del 50% 


##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { btn_re }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { Act_Windup }]; #IO_L24P_T3_34 Sch=sw[1]
...
##Pmod Header JA (XADC)
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { JA_p4 }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p		   
...
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { JA_n4 }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N        
