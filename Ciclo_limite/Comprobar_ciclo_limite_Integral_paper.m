...
if(mag1*Ki<alfa)
    fprintf("Se cumple A2, por lo cual puede que no haya ciclos limites");
else
    fprintf("No se cumple A2, por lo cual puede que haya ciclos limites");
end
