...
Kp=2.045875418664751;
Ki=0.002189694427541;
Ts=2.5e-05;
fc=372; %frecuencia de corte

%%Especifico de este paso

B_min_r=3;  %minimo numero de bits para los valores del regulador MINIMO 2!!!
...
% Crear una nueva TF con los nuevos valores
         z = tf('z',Ts);
         Gcz_cuant = Kp_cuant.xq + Ki_cuant.xq /(1-z^-1);
...
%         Ver si se cumplen las 3 condiciones
    ...
    if( Er_m_f0_real<Er_m_f0 && Er_m_fc_real<Er_m_fc && Er_f_fc_real<Er_f_fc )
        ...
        fprintf("\n Kp=  %d B_Kp= %d",Kp_cuant.xq,B_Kp);
        fprintf("\n Ki=  %d B_Ki= %d",Ki_cuant.xq,B_Ki);
        fprintf("\n Los errores son:");
